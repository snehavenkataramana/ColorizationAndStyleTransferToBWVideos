...
class SIGGRAPHGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, norm_layer=nn.BatchNorm2d, use_tanh=True, classification=True):
        ...
        model3=[nn.Conv2d(128, 256, kernel_size=1, stride=1, padding=1, bias=use_bias),]
        # model3+=[norm_layer(256),]
        model3+=[nn.ReLU(True),]
        # model3+=[nn.ReflectionPad2d(1),]
        model3+=[nn.Conv2d(256, 256, kernel_size=1, stride=1, padding=1, bias=use_bias),]
        # model3+=[norm_layer(256),]
        model3+=[nn.ReLU(True),]
        # model3+=[nn.ReflectionPad2d(1),]
        model3+=[nn.Conv2d(256, 256, kernel_size=1, stride=1, padding=1, bias=use_bias),]
        ...
        model4=[nn.Conv2d(256, 512, kernel_size=1, stride=1, padding=1, bias=use_bias),]
        # model4+=[norm_layer(512),]
        model4+=[nn.ReLU(True),]
        # model4+=[nn.ReflectionPad2d(1),]
        model4+=[nn.Conv2d(512, 512, kernel_size=1, stride=1, padding=1, bias=use_bias),]
        # model4+=[norm_layer(512),]
        model4+=[nn.ReLU(True),]
        # model4+=[nn.ReflectionPad2d(1),]
        model4+=[nn.Conv2d(512, 512, kernel_size=1, stride=1, padding=1, bias=use_bias),]
        ...
        model5=[nn.Conv2d(512, 512, kernel_size=1, dilation=2, stride=1, padding=2, bias=use_bias),]
        ...
        model6=[nn.Conv2d(512, 512, kernel_size=1, dilation=2, stride=1, padding=2, bias=use_bias),]
        ...
        # Conv7
        # model47+=[nn.ReflectionPad2d(1),]
        model7=[nn.Conv2d(512, 512, kernel_size=1, stride=1, padding=1, bias=use_bias),]
        ...
        # Conv7_new (another fire module)
        # model47+=[nn.ReflectionPad2d(1),]
        model7_1=[nn.Conv2d(512, 512, kernel_size=1, stride=1, padding=1, bias=use_bias),]
        # model7+=[norm_layer(512),]
    ...
    def forward(self, input_A, input_B, mask_B):
        ...
        conv7_3_1 = self.model7(conv7_3)
        conv7_3_2 = self.model7(conv7_3)
        conv8_up = self.model8up(conv7_3_2) + self.model3short8(conv3_3)
