...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', type=str, default='/home/ubuntu/code/colorization-pytorch/dataset/ilsvrc2012/train', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
